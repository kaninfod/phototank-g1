...
(function() {
  var toggleBucket, update_bucket_count;

  $(document).ready(function() {
    update_bucket_count();
    return $('#photos').on('click', '.photo-widget .photo-widget-header img', function() {
      var overlay;
  ...
  toggleBucket = function(photoOverlay) {
    var imgDiv, url;
  ...
  $(function() {
    $('#photo_bucket_panel').click(function() {
  ...
  update_bucket_count = function() {
    return $.get('/bucket/count', function(data) {
      return $('#bucket_counter').html(data['count']);
    });
  };
...
(function() {
  $(function() {
    return $('.sidebar-menu > li').click(function(e) {
...
(function() {
  ...
  $(function() {
    return $('.searchbox, .breadcrumb li a').on('click', function() {
      var el, url;
      el = $(this);
      url = el.attr("href");
  ...
  $(function() {
    return $('#country').on('change', function() {
      var dateUrl;
      dateUrl = $('.breadcrumb').attr('date_url');
      if (country !== "Filter on country...") {
        return window.location = dateUrl + getCountryUrl();
      } else {
        return window.location = dateUrl;
      }
    });
  });

  getCountryUrl = function() {
    var country;
    country = $("#country").val();
    if (country !== "Filter on country...") {
